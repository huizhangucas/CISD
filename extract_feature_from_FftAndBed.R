...
extract_feature_from_FftAndBed_5k = function(fft_profile,bed){
  
  f6=extract_from_bed(data.frame(fft_profile[,6]),bed,5000,100)
  f6=rowMeans(f6[,17:28])+rowMeans(f6[,23:34])-rowMeans(f6[,23:28])
  
  f7=extract_from_bed(data.frame(fft_profile[,7]),bed,5000,100)
  f7=rowMeans(f7[,16:35])
  
  return(cbind(f7,f6))
}

extract_feature_from_FftAndBed_old = function(fft_profile,bed){
  
  f6=extract_from_bed(data.frame(fft_profile[,6]),bed,1600,100)
  f6=rowMeans(f6[,c(1:5,12:16)])
  
  f7=extract_from_bed(data.frame(fft_profile[,7]),bed,2000,100)
  f7=rowMeans(f7)
  
  return(cbind(f7,f6))
}

extract_feature_from_FftAndBed = function(fft_profile,bed){
  ...
  return(cbind(f1,f6,f7))
}


extract_feature_from_FftAndBed_f_1to10 = function(fft_profile,bed){
  ...
  return(cbind(f7,f6,f1,f2,f3,f4,f5,f8,f9,f10))
}


extract_feature_from_FftAndBed_f_1to15 = function(fft_profile,bed){
  ...
  return(cbind(f1,f2,f3,f4,f5,f6,f7,f8,f9,f10,f11,f12,f13,f14,f15))
}
